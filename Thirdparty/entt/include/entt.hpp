 ...
 */
     ...
     */
        ...
        /*! @copydoc erase */
        [[deprecated("use ::erase instead")]] void destroy(const entity_type entt)
        {
            erase(entt);
        }
 ...
 */
     ...
     */
        ...
        /*! @copydoc insert */
        template <typename It>
        [[deprecated("use ::insert instead")]] std::enable_if_t<std::is_same_v<typename std::iterator_traits<It>::value_type, entity_type>, void>
     ...
     */
        ...
        /*! @copydoc insert */
        template <typename EIt, typename CIt>
        [[deprecated("use ::insert instead")]] std::enable_if_t<std::is_same_v<typename std::iterator_traits<EIt>::value_type, entity_type>, void>
        ...
        void sort(iterator first, iterator last, Compare compare, Sort algo = Sort{}, Args &&... args)
        {
            ...
            if constexpr (std::is_invocable_v<Compare, const object_type &, const object_type &>)
            {
                underlying_type::arrange(
                    from, to, std::move(apply), [this, compare = std::move(compare)](const auto lhs, const auto rhs) {
 ...
 */
     ...
     */
        ...
        void sort(Compare compare, Sort algo = Sort{}, Args &&... args)
        {
            ...
            {
                handler->sort(
                    handler->begin(), handler->end(), [this, compare = std::move(compare)](const entity_type lhs, const entity_type rhs) {
 ...
 */
     ...
     */
        ...
        void sort(Compare compare, Sort algo = Sort{}, Args &&... args)
        {
            ...
            {
                cpool->sort(
                    cpool->end() - *length, cpool->end(), [this, compare = std::move(compare)](const entity_type lhs, const entity_type rhs) {
                        return compare((std::get<pool_type<Component> *>(pools)->get(lhs), ...), (std::get<pool_type<Component> *>(pools)->get(rhs), ...));
                    },
                    std::move(algo), std::forward<Args>(args)...);
            }
 ...
 */
     ...
     */
        template <typename Archive>
        [[deprecated("use ::entities instead, it exports now also destroyed entities")]] const basic_snapshot &destroyed(Archive &) const { return *this; }
 ...
 */
     ...
     */
        template <typename Archive>
        [[deprecated("use ::entities instead, it imports now also destroyed entities")]] const basic_snapshot_loader &destroyed(Archive &) const { return *this; }
 ...
 */
     ...
     */
        template <typename Archive>
        [[deprecated("use ::entities instead, it imports now also destroyed entities")]] basic_continuous_loader &destroyed(Archive &) { return *this; }
 ...
 */
    ...
    class basic_view<Entity, exclude_t<Exclude...>, Component...>
    {
        ...
        class view_iterator final
        {
            ...
            bool valid() const
            {
                return std::all_of(unchecked.cbegin(), unchecked.cend(), [entt = *it](const sparse_set<Entity> *curr) { return curr->contains(entt); }) && std::none_of(filter.cbegin(), filter.cend(), [entt = *it](const sparse_set<Entity> *curr) { return curr->contains(entt); });
            }
     ...
     */
        bool contains(const entity_type entt) const
        {
            return (std::get<pool_type<Component> *>(pools)->contains(entt) && ...) && (!std::get<pool_type<Exclude> *>(pools)->contains(entt) && ...);
        }
 ...
 */
    ...
    class basic_registry
    {
        ...
        struct group_handler<exclude_t<Exclude...>, get_t<Get...>, Owned...>
        {
            ...
            void maybe_valid_if(basic_registry &owner, const Entity entt)
            {
                ...
                const auto is_valid = ((std::is_same_v<Component, Owned> || std::get<pool_handler<Owned> &>(cpools).contains(entt)) && ...) && ((std::is_same_v<Component, Get> || owner.assure<Get>().contains(entt)) && ...) && ((std::is_same_v<Component, Exclude> || !owner.assure<Exclude>().contains(entt)) && ...);
     ...
     */
        ...
        /*! @copydoc emplace */
        template <typename Component, typename... Args>
        [[deprecated("use ::emplace instead")]] decltype(auto) assign(const entity_type entity, Args &&... args)
        {
     ...
     */
        ...
        template <typename Component, typename... Args>
        [[deprecated("use ::emplace_or_replace instead")]] decltype(auto) assign_or_replace(const entity_type entity, Args &&... args)
        {
     ...
     */
        ...
        /*! @copydoc patch */
        template <typename Component, typename... Func>
        [[deprecated("use registry::patch instead")]] auto replace(const entity_type entity, Func &&... func)
     ...
     */
        ...
        template <typename Component, typename... Args>
        [[deprecated("use ::get_or_emplace instead")]] decltype(auto) get_or_assign(const entity_type entity, Args &&... args)
        {
     ...
     */
        ...
        entt::basic_group<Entity, exclude_t<Exclude...>, get_t<Get...>, Owned...> group(get_t<Get...>, exclude_t<Exclude...> = {})
        {
            ...
            if (auto it = std::find_if(groups.cbegin(), groups.cend(), [size](const auto &gdata) {
                    return gdata.size == size && (gdata.owned(type_info<std::decay_t<Owned>>::id()) && ...) && (gdata.get(type_info<std::decay_t<Get>>::id()) && ...) && (gdata.exclude(type_info<Exclude>::id()) && ...);
                });
                it != groups.cend())
            {
     ...
     */
        [[deprecated("basic_snapshot has now a constructor that accepts a reference to a registry")]] entt::basic_snapshot<Entity> snapshot() const
        {
            return {*this};
        }
     ...
     */
        [[deprecated("basic_snapshot_loader has now a constructor that accepts a reference to a registry")]] basic_snapshot_loader<Entity> loader()
        {
            return {*this};
        }
 ...
 */
    ...
    struct meta_data
    {
        ...
        /*! @copydoc id */
        [[deprecated("use ::id instead")]] id_type alias() const ENTT_NOEXCEPT
        {
            return id();
        }
        ...
        auto ctor(std::index_sequence<Indexes...>) const
        {
            return internal::find_if([](const auto *candidate) {
                return candidate->size == sizeof...(Args) && ([](auto *from, auto *to) {
                           return (from->type_id == to->type_id) || internal::find_if<&internal::meta_type_node::base>([to](const auto *curr) { return curr->type()->type_id == to->type_id; }, from) || internal::find_if<&internal::meta_type_node::conv>([to](const auto *curr) { return curr->type()->type_id == to->type_id; }, from);
 ...
 */
    ...
    /*! @copydoc resolve_id */
    [[deprecated("use entt::resolve_id instead")]] inline meta_type resolve(const id_type id) ENTT_NOEXCEPT
    {
