...
ViewPort::ViewPort(float left, float bottom, float width, float height)
	: m_Camera(left, left + width, bottom, bottom + height), m_CameraSpeed(7.0f), m_LevelWidth(40.0f), m_LevelHeight(20.0f), m_ScrollZoneSize(3.0f), m_ScrollX(8.0f), m_ScrollY(5.0f), m_Left(left), m_Bottom(bottom), m_Width(width), m_Height(height), m_NewLeft(left), m_NewBottom(bottom)
{
}
...
void ViewPort::Update(Rocket::Timestep ts)
{
